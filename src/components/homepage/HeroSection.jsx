...
export const HeroSection = ({setOption, setClicked}) => {
  ...
  return (
    <div className = "hero_section_container">
            ...
            <Button className = "signup_action_buttons" variant="contained" sx = {{padding:"5px 2rem", borderRadius:"100px"}} color ="secondary" onClick = {() => getStartedHandler()}>Get Started</Button>
            <Button className = "signup_action_buttons" variant="contained" sx = {{padding:"5px 2rem", borderRadius:"100px"}} onClick = {() => loginButtonHandler()} severity="warning">Login</Button>
            </div>
          </div>
  )
}
